...
<div class="content-container">
  ...
  <div class="area-section">
    ...
    <div class="area-wrapper" role="list">
      <div role="listitem">
        <a class="area-badge" data-src="" href="#cambridge-rn">
      ...
      <div role="listitem">
        <a class="area-badge" data-src="" href="#botanic-gardens-rn">
  ...
  <div class="area-list" role="list">
    <div role="listitem">
      <div class="area-item">
        <h3 class="area-heading" id="cambridge-rn">Cambridge RN</h3>
        <div>
          <div class="site-item">
    ...
    <div role="listitem">
      <div class="area-item">
        <h3 class="area-heading" id="newton-rn">Newton RN</h3>
        <div>
          <div class="site-item">
            <div class="site-media">
    ...
    <div role="listitem">
      <div class="area-item">
        <h3 class="area-heading" id="botanic-gardens-rn">Botanic Gardens RN</h3>
        <div>
          <div class="site-item">
            <div class="site-media">

      ...
      <div class="area-item">
        ...
        <div id="balmoral-rn">
          <div class="site-item" role="listitem">
            ...
            <a href="#" class="site-name">{name}</a>
            <div class="site-buttons">
              <a class="site-button directions" href="{maps_url}"><div>Directions</div>
                ...
                </svg> </a><a class="site-button" href="/heritage-sites/{slug}"><div>Learn More</div>
                <div>→</div></a>
            </div>
            <p class="site-description">{Summary}</p>
          </div>
        </div>
